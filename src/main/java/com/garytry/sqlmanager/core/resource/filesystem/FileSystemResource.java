 ...
 */
package com.garytry.sqlmanager.core.resource.filesystem;
...
public class FileSystemResource extends AbstractLoadableResource implements Comparable<FileSystemResource> {
    ...
    public LineReader loadAsString() {
        try {
            ...
            throw new sqlManagerException("Unable to load filesystem resource: " + file.getPath() + " (encoding: " + encoding + ")", e);
        }
    }
    ...
    public byte[] loadAsBytes() {
        try {
            ...
            throw new sqlManagerException("Unable to load filesystem resource: " + file.getPath(), e);
        }
    }
