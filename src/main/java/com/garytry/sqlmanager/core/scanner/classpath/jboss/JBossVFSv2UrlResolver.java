 ...
 */
package com.garytry.sqlmanager.core.scanner.classpath.jboss;


import com.garytry.sqlmanager.core.exception.sqlManagerException;
import com.garytry.sqlmanager.core.scanner.classpath.UrlResolver;
...
public class JBossVFSv2UrlResolver implements UrlResolver {
    public URL toStandardJavaUrl(URL url) {
        try {
            ...
            throw new sqlManagerException("JBoss VFS v2 call failed", e);
        }
    }
}