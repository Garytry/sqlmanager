 ...
 */
package com.garytry.sqlmanager.util;
...
public final class FeatureDetector {
    ...
    public boolean isApacheCommonsLoggingAvailable() {
        if (apacheCommonsLoggingAvailable == null) {
            apacheCommonsLoggingAvailable = org.flywaydb.core.internal.util.ClassUtils.isPresent("org.apache.commons.logging.Log", classLoader);
        }
    ...
    public boolean isSlf4jAvailable() {
        if (slf4jAvailable == null) {
            slf4jAvailable = org.flywaydb.core.internal.util.ClassUtils.isPresent("org.slf4j.Logger", classLoader);
        }
    ...
    public boolean isSpringJdbcAvailable() {
        if (springJdbcAvailable == null) {
            springJdbcAvailable = org.flywaydb.core.internal.util.ClassUtils.isPresent("org.springframework.jdbc.core.JdbcTemplate", classLoader);
    ...
    public boolean isJBossVFSv2Available() {
        if (jbossVFSv2Available == null) {
            jbossVFSv2Available = org.flywaydb.core.internal.util.ClassUtils.isPresent("org.jboss.virtual.VFS", classLoader);
    ...
    public boolean isJBossVFSv3Available() {
        if (jbossVFSv3Available == null) {
            jbossVFSv3Available = org.flywaydb.core.internal.util.ClassUtils.isPresent("org.jboss.vfs.VFS", classLoader);
